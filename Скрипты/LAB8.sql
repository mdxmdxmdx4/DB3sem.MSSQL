declare @ch char = 'o',
		...
		@de numeric(12, 5);
		set @dt = GETDATE();
		select @time = CAST('11:03:53' as	time), @i = 123, @ti = 1, @de =  0.312331;
...
--!!!!!!!!!!!!!!!!!!!!
declare @name nvarchar(30) = N'Комарова Елизавета Ивановна',
@name2 nvarchar(20),
@len int,
@pr int
set @len = len(@name)
...
END as N'День недели',
PROGRESS.SUBJECT, PROGRESS.PDATE
...
declare @name nvarchar(25) = N'Отодрач Кирилл Алексеевич',
@name2 nvarchar(20),
@pr int		
set @pr = patindex('% %', @name)
--print @pr
